...
class FaceNetService {
  ...
  setCurrentPrediction(var cameraImage, Face face) {
  ...
  /* Future<String> predict() async {
    ...
    String presdata = await _searchResult(this._predictedData);
  ...
  /// [face]: face detected
  List _preProcess(var image, Face faceDetected) {
    // crops the face
    imglib.Image croppedImage = _cropFace(image, faceDetected);
    imglib.Image img = imglib.copyResizeCropSquare(croppedImage, 112);

    // image.runtimeType == imglib.Image ? image :
  ...
  /// [cameraImage]: current image
  /// [face]: face detected
  _cropFace(var image, Face faceDetected) {
    if (image.runtimeType == CameraImage) {
